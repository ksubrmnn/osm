...
func TestListTrafficTargetPermutations(t *testing.T) {
	...
	trafficTargets := listTrafficTargetPermutations(tests.BookstoreTrafficTargetName, srcList, destList)
	...
	expected := []string{
		utils.GetTrafficTargetName(tests.BookstoreTrafficTargetName, srcList[0], destList[0]),
		utils.GetTrafficTargetName(tests.BookstoreTrafficTargetName, srcList[0], destList[1]),
		utils.GetTrafficTargetName(tests.BookstoreTrafficTargetName, srcList[1], destList[0]),
		utils.GetTrafficTargetName(tests.BookstoreTrafficTargetName, srcList[1], destList[1]),
	}
	assert.ElementsMatch(actualTargetNames, expected)
}
